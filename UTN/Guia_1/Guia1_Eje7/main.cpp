...
cobraría tan solo $300.*/
    ...
    float valorOriginal, valorDescuento, porcentajeAplicado, monto;


    cout << "Ingrese el importe de la venta: $";
    cin >> valorOriginal;

    cout << "El valor con descuento es de: $";
    cin >> valorDescuento;

    porcentajeAplicado = (valorOriginal - valorDescuento) *100 / valorOriginal;

    cout << "El descuento aplicado fue: "<<"%"<<porcentajeAplicado<<endl;
