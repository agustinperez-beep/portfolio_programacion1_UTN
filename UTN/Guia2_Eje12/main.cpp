...
int main()
{
    /*12 Hacer un programa en el que se ingrese la edad y altura de 5 personas. Luego,
    calcular e informar:
    ...
    int edad, mayores30=0, cantMayor30=0, alturaMedia=0, edadPromedio=0;
    float promedio, altura;
